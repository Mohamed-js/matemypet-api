class AvatarsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @avatar.save
        format.html { redirect_to avatar_url(@avatar), notice: "Avatar was successfully created." }
  ...
  def update
    respond_to do |format|
      if @avatar.update(avatar_params)
        format.html { redirect_to avatar_url(@avatar), notice: "Avatar was successfully updated." }
  ...
  private
    ...
    def avatar_params
      params.require(:avatar).permit(:animal_id, :url, :caption)
    end
end
