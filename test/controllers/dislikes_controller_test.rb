...
class DislikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dislike" do
    assert_difference("Dislike.count") do
      post dislikes_url, params: { dislike: { disliked_animal_id: @dislike.disliked_animal_id, disliker_animal_id: @dislike.disliker_animal_id, disliker_user_id: @dislike.disliker_user_id } }
    end
  ...
  test "should update dislike" do
    patch dislike_url(@dislike), params: { dislike: { disliked_animal_id: @dislike.disliked_animal_id, disliker_animal_id: @dislike.disliker_animal_id, disliker_user_id: @dislike.disliker_user_id } }
