class UserReportsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_report.save
        format.html { redirect_to user_report_url(@user_report), notice: "User report was successfully created." }
  ...
  private
    ...
    def user_report_params
      params.require(:user_report).permit(:user_id, :reported_id, :reported_type, :body, :image, :read)
    end
end
