...
class AvatarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avatar" do
    assert_difference("Avatar.count") do
      post avatars_url, params: { avatar: { animal_id: @avatar.animal_id, caption: @avatar.caption, url: @avatar.url } }
    end
  ...
  test "should update avatar" do
    patch avatar_url(@avatar), params: { avatar: { animal_id: @avatar.animal_id, caption: @avatar.caption, url: @avatar.url } }
