...
class UserNotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_notification" do
    assert_difference("UserNotification.count") do
      post user_notifications_url, params: { user_notification: { body: @user_notification.body, image: @user_notification.image, redirect_to: @user_notification.redirect_to, redirect_to_id: @user_notification.redirect_to_id, title: @user_notification.title, user_id: @user_notification.user_id } }
    end
  ...
  test "should update user_notification" do
    patch user_notification_url(@user_notification), params: { user_notification: { body: @user_notification.body, image: @user_notification.image, redirect_to: @user_notification.redirect_to, redirect_to_id: @user_notification.redirect_to_id, title: @user_notification.title, user_id: @user_notification.user_id } }
