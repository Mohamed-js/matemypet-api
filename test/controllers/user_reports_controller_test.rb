...
class UserReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_report" do
    assert_difference("UserReport.count") do
      post user_reports_url, params: { user_report: { body: @user_report.body, image: @user_report.image, read: @user_report.read, reported_id: @user_report.reported_id, reported_type: @user_report.reported_type, user_id: @user_report.user_id } }
    end
  ...
  test "should update user_report" do
    patch user_report_url(@user_report), params: { user_report: { body: @user_report.body, image: @user_report.image, read: @user_report.read, reported_id: @user_report.reported_id, reported_type: @user_report.reported_type, user_id: @user_report.user_id } }
